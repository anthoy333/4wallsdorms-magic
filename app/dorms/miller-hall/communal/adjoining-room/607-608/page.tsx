...
export default function MillerHallAdjoiningRoom607608Page() {
  const router = useRouter()

  // Adjoining room data for rooms 607-608
  const adjoiningRoomData = {
    id: "607-608",
    title: "Miller Hall Adjoining Room 607 + 608",
    ...
    sharedSpaces: {
      bathroom: {
        ...
        description: "Modern shared bathroom connecting rooms 607 and 608",
        features: [
          "Shared bathroom",
      ...
      "bathroom-dimensions": {
        ...
        description: "Detailed measurements for the shared bathroom space between rooms 607 and 608",
        features: [],
        dimensions: {
  ...
  return (
    <AdjoiningRoomPageTemplate
      ...
      roomTitle="Adjoining Rooms 607 + 608"
      ...
      floorPlanAlt="Rooms 607-608 Jack and Jill Floor Plan"

      // Upload and contact links
      uploadDormLink="/upload-dorm?school=Suffolk%20University&campus=Boston&dorm=Miller%20Hall&floor=6&rooms=607-608"
