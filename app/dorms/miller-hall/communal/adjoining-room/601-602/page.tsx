...
export default function MillerHallAdjoiningRoom601602Page() {
  const router = useRouter()

  // Adjoining room data for rooms 601-602
  const adjoiningRoomData = {
    id: "601-602",
    title: "Miller Hall Adjoining Room 601 + 602",
    description: "Two connected double rooms on the sixth floor sharing a Jack and Jill bathroom.",
    roomNumbers: ["601", "602"],
    ...
    sharedSpaces: {
      bathroom: {
        ...
        description: "Modern shared bathroom connecting rooms 601 and 602",
        features: [
          "Shared bathroom",
      ...
      "bathroom-dimensions": {
        ...
        description: "Detailed measurements for the shared bathroom space between rooms 601 and 602",
        features: [],
        dimensions: {
  ...
  return (
    <AdjoiningRoomPageTemplate
      ...
      roomTitle="Adjoining Rooms 601 + 602"
      ...
      floorPlanAlt="Rooms 601-602 Jack and Jill Floor Plan"

      // Upload and contact links
      uploadDormLink="/upload-dorm?school=Suffolk%20University&campus=Boston&dorm=Miller%20Hall&floor=6&rooms=601-602"
