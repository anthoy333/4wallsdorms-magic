...
export default function MillerHallRoom1005Page() {
  ...
  const roomDetails = {
    ...
    features: [
      "Carpeted room",
      "Shared bathroom with Room 1006",
    ...
    photos: [
      ...
      {
        type: "image",
        src: "https://f005.backblazeb2.com/file/4wallsdorms/Suffolk+University+Dorms/Miller/Floor+10/1005+%2B+1006/1005millersuffolk.jpg",
        alt: "Room 1005 - View 3"
      }
    ],
