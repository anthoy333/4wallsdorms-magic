...
export default function MillerHallRoom407Page() {
  const roomDetails = {
    name: "Room 407",
    description: "A comfortable double room in Miller Hall featuring modern amenities and excellent natural light. This room is part of an adjoining room setup with Room 408.",
    size: "225 sq ft",
    occupancy: "Double",
    features: [
      "Carpeted room",
      "Shared bathroom with Room 408",
  ...
  return (
    <RoomPageTemplate
      ...
      roomTitle="Room 407"
      address="10 Somerset St, Boston, MA 02108, Floor 4, Room 407"
      ...
      floorPlanAlt="Room 407 Floor Plan Layout - 4th Floor"

      // Adjoining room section
      adjoiningRoomLink="/dorms/miller-hall/communal/adjoining-room/407-408"
      adjoiningRoomTitle="407 + 408"
      adjoiningRoomDescription="This room is part of an adjoining room setup with Room 408, sharing a Jack and Jill bathroom."
      ...
      uploadDormLink="/upload-dorm?school=Suffolk%20University&campus=Boston&dorm=Miller%20Hall&floor=4&room=407"
