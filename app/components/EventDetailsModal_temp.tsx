...
const EventDetailsModal: React.FC<EventDetailsModalProps> = ({ event, isOpen, onClose }) => {
  ...
  const getOverview = (clubName: string) => {
    const overviews: Record<string, any> = {
      ...
      'The Suffolk Journal': {
        content: 'EBOARD_PLACEHOLDER overview content',
        source: null
      },
      'Entrepreneurship Club': {
    ...
    return overviews[clubName] || { content: 'EBOARD_PLACEHOLDER overview content', source: null };
  };
          ...
          <div className="min-h-[200px] max-h-[300px] overflow-y-auto">
                  ...
                  {(() => {
                    ...
                    return updates.length > 0 ? (
                      ...
                      <div className="text-center py-6">
                        <p className="text-gray-500 text-lg mb-4">EBOARD_PLACEHOLDER</p>
                        <a
            ...
            {activeTab === 'Overview' && (
              <div className="space-y-4">
                ...
                {(() => {
                  const overview = event ? getOverview(event.clubName) : { content: 'EBOARD_PLACEHOLDER overview content', source: null };
                  return overview.content === 'EBOARD_PLACEHOLDER overview content' ? (
                    <div className="text-center py-6">
                      <p className="text-gray-500 text-lg mb-4">EBOARD_PLACEHOLDER</p>
                      <a
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 px-8">
            ...
            {socialMediaLinks.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-500 mb-4">EBOARD_PLACEHOLDER</p>
                <a
